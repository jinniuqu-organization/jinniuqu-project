...
public class ServerController {
    ...
    public AjaxResponse findDe(){
        ...
        try{
            List<CollectCondition> list = serverService.findDe();
    ...
    public AjaxResponse findLine (){
        ...
        try{
            List<CharMap> list = serverService.findLine();
            if(!CollectionUtils.isEmpty(list)){
    ...
    public AjaxResponse findData(@RequestBody CollectCondition collectCondition){
        ...
        try{
            List list = serverService.findData(collectCondition);
            if(!CollectionUtils.isEmpty(list)){
    ...
    public AjaxResponse findAmount(){
        try{
            DataCollect list = serverService.findAmount();
            if(list != null){
